 ...
 * @LastEditTime: 2021-08-24 10:14:26
 * @LastEditors: Please set LastEditors
 * @Description: 流程工作台-我发起的流程
 * @FilePath: /flow-template-front/src/views/workBench/sent/SentMission.vue
-->
<template>
...
import { getTableData, getSentTableData, getTimelineList, getButton, getProcessImg } from '@/api/workmenu/sentmission'
...
export default {
  ...
  methods: {
    async getList() {
      this.loading = true;
      const { data, totalNum } = await getSentTableData(this.queryParams)
