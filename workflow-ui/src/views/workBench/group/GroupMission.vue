...
import { getTableData, getGroupTableData, claimTask, getProcessImg } from '@/api/workmenu/groupmission'
...
export default {
  ...
  methods: {
    async getList() {
      this.loading = true;
      const { data, totalNum } = await getGroupTableData(this.queryParams)
