...
<script>
import { roleList, userList } from "@/api/processcenter/definition";
...
export default {
  ...
  methods: {
    ...
    getModelDetail(deployId) {
      // 发送请求，获取xml
      this.$route.query.bpmn.readXml(deployId).then(res =>{
        this.xml = res.data;
    ...
    save(data) {
      ...
      this.$route.query.bpmn.saveXml(params).then(res => {
